...
namespace MenuHopital
{
    class Program
    {
        ...
        public static void MenuSecretaire(Authentification auth)
        {
            ...
            Console.WriteLine("6 - Liste des visites par date");
            Console.WriteLine("7 - Liste des visites par médecin");
            Console.WriteLine("8 - Nombre total de visites");
            Console.WriteLine("9 - Nombre de visites entre deux dates");
            ...
            switch(choix)
            {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    H.ListeVisiteParDate();
                    MenuSecretaire(auth);
                    break;
                case 7:
                    H.ListeVisiteParMedecin();
                    MenuSecretaire(auth);
                    break;
                case 8:
                    H.NombreTotalDeVisite();
                    MenuSecretaire(auth);
                    break;
                case 9:
